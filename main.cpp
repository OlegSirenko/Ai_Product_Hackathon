...
int main(int, char**) {
    ...
    GLFWwindow *window = glfwCreateWindow(1280, 720, "Ai_Product_Hackathon", nullptr, nullptr);
    if (window == nullptr)
        return 1;
    ...
    imageWindow.LoadTexturesFromDirectory(std::filesystem::current_path().string()+R"(\scenes)");
    ControlPanel controlPanel;
    controlPanel.LoadTexturesFromDirectory(std::filesystem::current_path().string()+R"(\items)");
    // Main loop
...
void embraceTheDarkness()
{
    ...
    colors[ImGuiCol_ButtonActive]           = ImVec4(0.20f, 0.39f, 0.23f, 1.00f);
